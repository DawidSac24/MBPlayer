...
//		Error_Handler();
//	}
//	uint16_t *audio_start = (uint16_t*) &my_audio_array[22];
//	uint32_t audio_data_length = AUDIO_ARRAY_SIZE - 22;
	/* USER CODE END 2 */
...
//	list_files();
	...
	while (1) {
		...
		/* USER CODE BEGIN 3 */
//		printf("Hello World!\r\n");
		/* Toggle the green LED so we know the loop is running */
...
void Error_Handler(void) {
	...
	printf(
			"\r\n\033[31m[SYSTEM HALTED] SD Card Initialization Failed!\033[0m\r\n");
